                                        ...
                                        function enablePointerEvent() {
                                            if (!pointerInitialized) {
                                                ...
                                                if (obj.throttlingInterval < 17) {
                                                    ...
                                                    me.video.getScreenCanvas().addEventListener(activeEventList[1], throttle(obj.throttlingInterval, false, function(e) {
                                                        onMoveEvent(e)
                                                    }), false);
                                                }
